...
class SendCall():
    ...
    def Porsche(self):
        try:
            ...
            if r.status_code == 302:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı Siparişiniz Verildi! --> porsche.com.tr")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız Siparişiniz Verilemedi! --> porsche.com.tr")
    ...
    def Pratik(self):
        try:
            ...
            if "Kaydınız alınmıştır." in r.text:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı Siparişiniz Verildi! --> pratikdepo.com")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız Siparişiniz Verilemedi! --> pratikdepo.com")
    ...
    def CinselTerapi(self):
        try:
            ...
            if r.json()["message"] == 'Mesajın için teşekkürler. Gönderildi.':
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı Siparişiniz Verildi! --> cinselterapi.info")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız Siparişiniz Verilemedi! --> cinselterapi.info")
    ...
    def Otelz(self):
        try:
            ...
            if r.text == "true":
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı Siparişiniz Verildi! --> otelz.com")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız Siparişiniz Verilemedi! --> otelz.com")
    ...
    def Express(self):
        try:
            ...
            if r.json()["message"] == 'Mesajınız için teşekkürler. Gönderildi.':
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı Siparişiniz Verildi! --> expressdekor.com")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız Siparişiniz Verilemedi! --> expressdekor.com")
    ...
    def Thepick(self):
        try:
            ...
            if r.json()["message"] == 'Thank you for your message. It has been sent.':
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı Siparişiniz Verildi! --> thepicktolight.com")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız Siparişiniz Verilemedi! --> thepicktolight.com")
    ...
    def Vajini(self):
        try:
            ...
            if r.status_code == 303:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı Siparişiniz Verildi! --> vajinismustedavimerkezi.net")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız Siparişiniz Verilemedi! --> vajinismustedavimerkezi.net")
    ...
    def GmcYatirim(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data, allow_redirects=False)
            if (r.status_code) == 302:
                print(f"{Fore.LIGHTGREEN_EX}[+] {Style.RESET_ALL}Başarılı Siparişiniz Verildi! --> gcmyatirim.com.tr")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[-] {Style.RESET_ALL}Başarısız Siparişiniz Verilemedi! --> gcmyatirim.com.tr")