...
r = get("https://raw.githubusercontent.com/Azitro/Azitrov3/main/sms.py").text
...
r = get("https://raw.githubusercontent.com/Azitro/Azitrov2/main/call.py").text
...
while 1:
 ...
 |___/ | .__/   \___|  \___|  \__|  \__,_| |_|     \___/  |___/ |___/
    ...
    if menu == 1:
        ...
        system("cls||clear")
        print(Fore.LIGHTWHITE_EX + "İnstagram: @spectaross\n Discord: https://discord.gg/zaaf")
        sleep(12)
    elif menu == 4:
        system("cls||clear")
