...
r = get("https://raw.githubusercontent.com/Azitro/Azitro/main/sms.py").text
...
async def on_ready():
    ...
    activity = discord.Activity(type=discord.ActivityType.playing, name="https://github.com/Azitro/Azitro")
